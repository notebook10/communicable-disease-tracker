...
?>
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' name='date' id="searchdate" class='form-control' minlength=4 required/>
                        </div>

                        <div class="form-group">
                            <label for="time">Time</label>
                            <input type='text' name='time' id="searchtime" class='form-control' minlength=4 required/>
                        </div>
        ...
        <div class="card-body card__content">
            <?php
                ...
                if($_POST && isset($_POST["location_id"]) && $_POST['operation'] === 'search') {
                    ...
                    if($searchNum > 0) {
                        $table = "";
                        $table .= "<table class='pure-table w-100'>";
